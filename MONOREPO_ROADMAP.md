...
- **R2: Frontend.** Same convention with a Node toolchain. The `new-service` templates gain a Node variant. The frontend consumes `contracts/openapi/*`. **Started 2026-09-25:** imported as `services/web-plusdas` (see the log). Open: generated API types (`services/web-plusdas/docs/api-types-follow-up.md`), a Node variant of the `new-service` templates.
